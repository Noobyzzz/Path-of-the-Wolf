...
public class Ymir : MonoBehaviour
{
  ...
  void Awake()
  {
   ...
   // _gameManager = GameObject.Find("Game Manager").GetComponent<GameManger>();
    ...
    _animator.SetBool("Ymir walk", true);
  ...
  {
    _ymirHealth -= damage; //resta uno a la variable vida
  ...
  public void YmirDeath()
  {
    _animator.SetBool("Ymir idle", true);
